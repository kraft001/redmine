...
class MailHandler < ActionMailer::Base
  ...
  def receive_issue
    ...
    tracker = (get_keyword(:tracker) && project.trackers.find_by_name(get_keyword(:tracker)) || project.trackers.find_id(get_keyword(:tracker)) || project.trackers.find(:first))
